...
const PrivacyPolicy = () => {
  return (
    <HeaderItem title={"Privacy Policy"}>
      <Container>
        <TextContainer>
          <Title>Last updated: February 15, 2022</Title>
          <Description>
            At KachaBazar, accessible from kachabazar dot com, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by KachaBazar and how we use it. If you have additional
          ...
          <Description>
            ...
            that they shared and/or collect in KachaBazar.we may receive
        ...
        <TextContainer>
          ...
          <List>
            ...
            <ListItem>
              Develop new products, services, features, and functionality,and
            ...
            <ListItem>
              Send you emails. To provide you with updates and other information
              relating to the website, and for marketing and promotional
              purposes
            </ListItem>
            <ListItem>
              {" "}
              Find and prevent fraud. To provide you with updates and other
        ...
        <TextContainer>
          ...
          <Description>
            KachaBazar follows a standard procedure of using log files. These
        ...
        <TextContainer>
          ...
          <Description>
            ...
            that you see on websites that you visit. Note that KachaBazar has no
        ...
        <TextContainer>
          ...
          <Description>
            ...
            respective advertisements and links that appear on KachaBazar, which
            ...
            you visit. Note that KachaBazar has no access to or control over
        ...
        <TextContainer>
          <Title>CCPA Privacy Rights</Title>
          <Description>
