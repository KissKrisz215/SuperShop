...
const Footer = () => {
  return (
    <Wrapper>
        ...
        <SocialsContainer>
          <SocialMediaContainer>
            ...
            <SocialsLinkContainer>
              ...
              <SocialLink to="https://www.linkedin.com/" target="_blank">
                <svg viewBox="0 0 64 64" width="34" height="34">
              ...
              <SocialLink href="https://www.whatsapp.com/" target="_blank">
                <svg viewBox="0 0 64 64" width="34" height="34">
          ...
          <PhoneContainer>
            <SocialsHeader>Call Us Today!</SocialsHeader>
      ...
      <RightReserverdContainer>
        <RightsReserved>
          <CopyRightHighlight>Copyright</CopyRightHighlight>
